...
public:
	...
	uint8                                         Pad_33681[0x7];                                    // 0x33681(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x033688, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x033680, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
...
static_assert(sizeof(USteamNetDriver) == 0x0004A0, "Wrong size on USteamNetDriver");
