...
#include "BattleTalk_Barret_classes.hpp"
#include "BattleTalk_Barret_parameters.hpp"
...
bool UBattleTalk_Barret_C::OnNotify(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattleTalk_Barret_C", "OnNotify");

	Params::BattleTalk_Barret_C_OnNotify Parms{};
...
bool UBattleTalk_Barret_C::OnNotifyWithAbility(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara, class AEndCharacter* targetChara, class FName& AbilityID, struct FEndDataTableBattleAbility& dataTableBattleAbility, bool bFinishBlow) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattleTalk_Barret_C", "OnNotifyWithAbility");

	Params::BattleTalk_Barret_C_OnNotifyWithAbility Parms{};
