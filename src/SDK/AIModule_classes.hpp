...
public:
	...
	uint8                                         bStopAILogicOnUnposses : 1;                        // 0x0418(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bLOSflag : 1;                                      // 0x0418(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSkipExtraLOSChecks : 1;                           // 0x0418(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowStrafe : 1;                                  // 0x0418(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bWantsPlayerState : 1;                             // 0x0418(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSetControlRotationFromPawnOrientation : 1;        // 0x0418(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_419[0x7];                                      // 0x0419(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPathFollowingComponent*                PathFollowingComponent;                            // 0x0420(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UBrainComponent*                        BrainComponent;                                    // 0x0428(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAIPerceptionComponent*                 PerceptionComponent;                               // 0x0430(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPawnActionsComponent*                  ActionsComp;                                       // 0x0438(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UBlackboardComponent*                   Blackboard;                                        // 0x0440(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGameplayTasksComponent*                CachedGameplayTasksComponent;                      // 0x0448(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UNavigationQueryFilter>     DefaultNavigationFilterClass;                      // 0x0450(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	UMulticastDelegateProperty_                   ReceiveMoveCompleted;                              // 0x0458(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAIController) == 0x000470, "Wrong size on AAIController");
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x000420, "Member 'AAIController::PathFollowingComponent' has a wrong offset!");
static_assert(offsetof(AAIController, BrainComponent) == 0x000428, "Member 'AAIController::BrainComponent' has a wrong offset!");
static_assert(offsetof(AAIController, PerceptionComponent) == 0x000430, "Member 'AAIController::PerceptionComponent' has a wrong offset!");
static_assert(offsetof(AAIController, ActionsComp) == 0x000438, "Member 'AAIController::ActionsComp' has a wrong offset!");
static_assert(offsetof(AAIController, Blackboard) == 0x000440, "Member 'AAIController::Blackboard' has a wrong offset!");
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x000448, "Member 'AAIController::CachedGameplayTasksComponent' has a wrong offset!");
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x000450, "Member 'AAIController::DefaultNavigationFilterClass' has a wrong offset!");
static_assert(offsetof(AAIController, ReceiveMoveCompleted) == 0x000458, "Member 'AAIController::ReceiveMoveCompleted' has a wrong offset!");
...
static_assert(sizeof(UAISense) == 0x000110, "Wrong size on UAISense");
...
static_assert(sizeof(UAISense_Hearing) == 0x000180, "Wrong size on UAISense_Hearing");
static_assert(offsetof(UAISense_Hearing, NoiseEvents) == 0x000110, "Member 'UAISense_Hearing::NoiseEvents' has a wrong offset!");
static_assert(offsetof(UAISense_Hearing, SpeedOfSoundSq) == 0x000120, "Member 'UAISense_Hearing::SpeedOfSoundSq' has a wrong offset!");
...
static_assert(sizeof(UAISense_Blueprint) == 0x000140, "Wrong size on UAISense_Blueprint");
static_assert(offsetof(UAISense_Blueprint, ListenerDataType) == 0x000110, "Member 'UAISense_Blueprint::ListenerDataType' has a wrong offset!");
static_assert(offsetof(UAISense_Blueprint, ListenerContainer) == 0x000118, "Member 'UAISense_Blueprint::ListenerContainer' has a wrong offset!");
static_assert(offsetof(UAISense_Blueprint, UnprocessedEvents) == 0x000128, "Member 'UAISense_Blueprint::UnprocessedEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Damage) == 0x000120, "Wrong size on UAISense_Damage");
static_assert(offsetof(UAISense_Damage, RegisteredEvents) == 0x000110, "Member 'UAISense_Damage::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Prediction) == 0x000120, "Wrong size on UAISense_Prediction");
static_assert(offsetof(UAISense_Prediction, RegisteredEvents) == 0x000110, "Member 'UAISense_Prediction::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Sight) == 0x0001F0, "Wrong size on UAISense_Sight");
static_assert(offsetof(UAISense_Sight, MaxTracesPerTick) == 0x0001C0, "Member 'UAISense_Sight::MaxTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MinQueriesPerTimeSliceCheck) == 0x0001C4, "Member 'UAISense_Sight::MinQueriesPerTimeSliceCheck' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxTimeSlicePerTick) == 0x0001C8, "Member 'UAISense_Sight::MaxTimeSlicePerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, HighImportanceQueryDistanceThreshold) == 0x0001D0, "Member 'UAISense_Sight::HighImportanceQueryDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxQueryImportance) == 0x0001D8, "Member 'UAISense_Sight::MaxQueryImportance' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, SightLimitQueryImportance) == 0x0001DC, "Member 'UAISense_Sight::SightLimitQueryImportance' has a wrong offset!");
...
static_assert(sizeof(UAISense_Team) == 0x000120, "Wrong size on UAISense_Team");
static_assert(offsetof(UAISense_Team, RegisteredEvents) == 0x000110, "Member 'UAISense_Team::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Touch) == 0x000120, "Wrong size on UAISense_Touch");
static_assert(offsetof(UAISense_Touch, RegisteredEvents) == 0x000110, "Member 'UAISense_Touch::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISenseBlueprintListener) == 0x0000B0, "Wrong size on UAISenseBlueprintListener");
...
public:
	...
	uint8                                         Pad_238[0x180];                                    // 0x0238(0x0180)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPathFollowingComponent) == 0x0003B8, "Wrong size on UPathFollowingComponent");
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x000410, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x0003C0, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, CharacterMovement) == 0x0003D0, "Member 'UCrowdFollowingComponent::CharacterMovement' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, AvoidanceGroup) == 0x0003D8, "Member 'UCrowdFollowingComponent::AvoidanceGroup' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, GroupsToAvoid) == 0x0003DC, "Member 'UCrowdFollowingComponent::GroupsToAvoid' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, GroupsToIgnore) == 0x0003E0, "Member 'UCrowdFollowingComponent::GroupsToIgnore' has a wrong offset!");
...
static_assert(sizeof(ADetourCrowdAIController) == 0x000470, "Wrong size on ADetourCrowdAIController");
...
public:
	...
	struct FAIDataProviderFloatValue              InnerSpace;                                        // 0x0150(0x0030)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FAIDataProviderFloatValue              YawOffset;                                         // 0x0180(0x0030)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryGenerator_Cone) == 0x0001B0, "Wrong size on UEnvQueryGenerator_Cone");
...
static_assert(offsetof(UEnvQueryGenerator_Cone, InnerSpace) == 0x000150, "Member 'UEnvQueryGenerator_Cone::InnerSpace' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, YawOffset) == 0x000180, "Member 'UEnvQueryGenerator_Cone::YawOffset' has a wrong offset!");
...
// Class AIModule.EnvQueryGenerator_SimpleEdgeGrid
// 0x0068 (0x00E8 - 0x0080)
class UEnvQueryGenerator_SimpleEdgeGrid final : public UEnvQueryGenerator_ProjectedPoints
{
public:
	struct FAIDataProviderFloatValue              GridSize;                                          // 0x0080(0x0030)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              SpaceBetween;                                      // 0x00B0(0x0030)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"EnvQueryGenerator_SimpleEdgeGrid">();
	}
	static class UEnvQueryGenerator_SimpleEdgeGrid* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEnvQueryGenerator_SimpleEdgeGrid>();
	}
};
static_assert(alignof(UEnvQueryGenerator_SimpleEdgeGrid) == 0x000008, "Wrong alignment on UEnvQueryGenerator_SimpleEdgeGrid");
static_assert(sizeof(UEnvQueryGenerator_SimpleEdgeGrid) == 0x0000E8, "Wrong size on UEnvQueryGenerator_SimpleEdgeGrid");
static_assert(offsetof(UEnvQueryGenerator_SimpleEdgeGrid, GridSize) == 0x000080, "Member 'UEnvQueryGenerator_SimpleEdgeGrid::GridSize' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_SimpleEdgeGrid, SpaceBetween) == 0x0000B0, "Member 'UEnvQueryGenerator_SimpleEdgeGrid::SpaceBetween' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_SimpleEdgeGrid, GenerateAround) == 0x0000E0, "Member 'UEnvQueryGenerator_SimpleEdgeGrid::GenerateAround' has a wrong offset!");
...
public:
	...
	class UEnvQuery*                              QueryTemplate;                                     // 0x0808(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x0810(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FAIDynamicParam>                QueryConfig;                                       // 0x0820(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         TimeLimitPerStep;                                  // 0x0830(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StepToDebugDraw;                                   // 0x0834(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEnvQueryHightlightMode                       HighlightMode;                                     // 0x0838(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_839[0x3];                                      // 0x0839(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDrawLabels : 1;                                   // 0x083C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawFailedItems : 1;                              // 0x083C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReRunQueryOnlyOnFinishedMove : 1;                 // 0x083C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldBeVisibleInGame : 1;                        // 0x083C(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTickDuringGame : 1;                               // 0x083C(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_83D[0x3];                                      // 0x083D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EEnvQueryRunMode                              QueryingMode;                                      // 0x0840(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_841[0x2F];                                     // 0x0841(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x000808, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x000810, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000820, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000830, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x000834, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000838, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x000840, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
...
static_assert(sizeof(AGridPathAIController) == 0x000470, "Wrong size on AGridPathAIController");
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x0003F0, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0003B8, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
