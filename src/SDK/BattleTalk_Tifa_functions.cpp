...
#include "BattleTalk_Tifa_classes.hpp"
#include "BattleTalk_Tifa_parameters.hpp"
...
bool UBattleTalk_Tifa_C::OnNotify(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattleTalk_Tifa_C", "OnNotify");

	Params::BattleTalk_Tifa_C_OnNotify Parms{};
...
bool UBattleTalk_Tifa_C::OnNotifyWithAbility(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara, class AEndCharacter* targetChara, class FName& AbilityID, struct FEndDataTableBattleAbility& dataTableBattleAbility, bool bFinishBlow) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattleTalk_Tifa_C", "OnNotifyWithAbility");

	Params::BattleTalk_Tifa_C_OnNotifyWithAbility Parms{};
