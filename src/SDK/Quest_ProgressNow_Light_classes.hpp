...
static_assert(sizeof(UQuest_ProgressNow_Light_C) == 0x000388, "Wrong size on UQuest_ProgressNow_Light_C");
static_assert(offsetof(UQuest_ProgressNow_Light_C, UberGraphFrame) == 0x000360, "Member 'UQuest_ProgressNow_Light_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UQuest_ProgressNow_Light_C, Loop_PlayerLoca) == 0x000368, "Member 'UQuest_ProgressNow_Light_C::Loop_PlayerLoca' has a wrong offset!");
static_assert(offsetof(UQuest_ProgressNow_Light_C, Img_Effect_00) == 0x000370, "Member 'UQuest_ProgressNow_Light_C::Img_Effect_00' has a wrong offset!");
static_assert(offsetof(UQuest_ProgressNow_Light_C, Img_Effect_01) == 0x000378, "Member 'UQuest_ProgressNow_Light_C::Img_Effect_01' has a wrong offset!");
static_assert(offsetof(UQuest_ProgressNow_Light_C, Img_Effect_02) == 0x000380, "Member 'UQuest_ProgressNow_Light_C::Img_Effect_02' has a wrong offset!");
