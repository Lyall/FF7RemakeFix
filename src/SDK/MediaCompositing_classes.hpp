...
{
public:
	class UMediaPlaneComponent*                   MediaPlane;                                        // 0x0378(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMediaPlane) == 0x000380, "Wrong size on AMediaPlane");
static_assert(offsetof(AMediaPlane, MediaPlane) == 0x000378, "Member 'AMediaPlane::MediaPlane' has a wrong offset!");
...
{
public:
	struct FMediaPlaneParameters                  Plane;                                             // 0x06F0(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMediaPlaneComponent) == 0x0007C0, "Wrong size on UMediaPlaneComponent");
static_assert(offsetof(UMediaPlaneComponent, Plane) == 0x0006F0, "Member 'UMediaPlaneComponent::Plane' has a wrong offset!");
...
static_assert(sizeof(UMediaPlaneFrustumComponent) == 0x0006F0, "Wrong size on UMediaPlaneFrustumComponent");
...
{
public:
	class FString                                 Proxy;                                             // 0x00D8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMediaSource*                           MediaSource;                                       // 0x00E8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneMediaSection) == 0x0000F0, "Wrong size on UMovieSceneMediaSection");
static_assert(offsetof(UMovieSceneMediaSection, Proxy) == 0x0000D8, "Member 'UMovieSceneMediaSection::Proxy' has a wrong offset!");
