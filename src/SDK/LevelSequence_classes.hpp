...
public:
	...
	bool                                          bAutoPlay;                                         // 0x0380(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_381[0x7];                                      // 0x0381(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x0388(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FSoftObjectPath                        LevelSequence;                                     // 0x03B8(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         AdditionalEventReceivers;                          // 0x03D0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	class ULevelSequenceBurnInOptions*            BurnInOptions;                                     // 0x03E0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, AdvancedDisplay, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMovieSceneBindingOverrides*            BindingOverrides;                                  // 0x03E8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, AdvancedDisplay, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F0[0x58];                                     // 0x03F0(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	class ULevelSequenceBurnIn*                   BurnInInstance;                                    // 0x0448(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class ULevelSequence* GetSequence(bool bLoad, bool bInitializePlayer, class FName LevelName) const;
...
static_assert(sizeof(ALevelSequenceActor) == 0x000450, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, bAutoPlay) == 0x000380, "Member 'ALevelSequenceActor::bAutoPlay' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x000388, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
...
static_assert(offsetof(ALevelSequenceActor, AdditionalEventReceivers) == 0x0003D0, "Member 'ALevelSequenceActor::AdditionalEventReceivers' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInOptions) == 0x0003E0, "Member 'ALevelSequenceActor::BurnInOptions' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BindingOverrides) == 0x0003E8, "Member 'ALevelSequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x000448, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
...
{
public:
	class UMovieScene*                            MovieScene;                                        // 0x0380(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLevelSequenceObjectReferenceMap       ObjectReferences;                                  // 0x0388(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(ULevelSequence, MovieScene) == 0x000380, "Member 'ULevelSequence::MovieScene' has a wrong offset!");
static_assert(offsetof(ULevelSequence, ObjectReferences) == 0x000388, "Member 'ULevelSequence::ObjectReferences' has a wrong offset!");
...
{
public:
	UMulticastDelegateProperty_                   OnCameraCut;                                       // 0x0820(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_830[0x30];                                     // 0x0830(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UObject*>                        AdditionalEventReceivers;                          // 0x0860(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequencePlayer) == 0x0008C0, "Wrong size on ULevelSequencePlayer");
...
static_assert(offsetof(ULevelSequencePlayer, AdditionalEventReceivers) == 0x000860, "Member 'ULevelSequencePlayer::AdditionalEventReceivers' has a wrong offset!");
