...
static_assert(sizeof(UMaterialExpressionARKitPassthroughCamera) == 0x0000A0, "Wrong size on UMaterialExpressionARKitPassthroughCamera");
...
static_assert(offsetof(UMaterialExpressionARKitPassthroughCamera, ConstCoordinate) == 0x000098, "Member 'UMaterialExpressionARKitPassthroughCamera::ConstCoordinate' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionARKitPassthroughCamera, TextureType) == 0x00009C, "Member 'UMaterialExpressionARKitPassthroughCamera::TextureType' has a wrong offset!");
