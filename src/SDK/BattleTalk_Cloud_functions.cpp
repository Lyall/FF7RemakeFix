...
#include "BattleTalk_Cloud_classes.hpp"
#include "BattleTalk_Cloud_parameters.hpp"
...
bool UBattleTalk_Cloud_C::OnNotifyWithAbility(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara, class AEndCharacter* targetChara, class FName& AbilityID, struct FEndDataTableBattleAbility& dataTableBattleAbility, bool bFinishBlow) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattleTalk_Cloud_C", "OnNotifyWithAbility");

	Params::BattleTalk_Cloud_C_OnNotifyWithAbility Parms{};
...
bool UBattleTalk_Cloud_C::OnNotify(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattleTalk_Cloud_C", "OnNotify");

	Params::BattleTalk_Cloud_C_OnNotify Parms{};
