...
public:
	...
	class FName                                   RefOnDisconnected;                                 // 0x0090(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieSceneSkeletalAnimationParams) == 0x000008, "Wrong alignment on FMovieSceneSkeletalAnimationParams");
static_assert(sizeof(FMovieSceneSkeletalAnimationParams) == 0x000098, "Wrong size on FMovieSceneSkeletalAnimationParams");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, RefOnDisconnected) == 0x000090, "Member 'FMovieSceneSkeletalAnimationParams::RefOnDisconnected' has a wrong offset!");
...
{
public:
	float                                         SectionStartTime;                                  // 0x0098(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SectionEndTime;                                    // 0x009C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplateParameters) == 0x0000A0, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplateParameters");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionStartTime) == 0x000098, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionEndTime) == 0x00009C, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
{
public:
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params;                                            // 0x0020(0x00A0)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplate) == 0x0000C0, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplate");
