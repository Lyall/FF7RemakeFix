...
static_assert(sizeof(LevelSequenceActor_GetSequence) == 0x000018, "Wrong size on LevelSequenceActor_GetSequence");
...
static_assert(offsetof(LevelSequenceActor_GetSequence, LevelName) == 0x000004, "Member 'LevelSequenceActor_GetSequence::LevelName' has a wrong offset!");
static_assert(offsetof(LevelSequenceActor_GetSequence, ReturnValue) == 0x000010, "Member 'LevelSequenceActor_GetSequence::ReturnValue' has a wrong offset!");
