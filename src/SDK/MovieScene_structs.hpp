...
struct alignas(0x08) FMovieSceneBindingOverrideData final
{
public:
...
static_assert(sizeof(FMovieSceneBindingOverrideData) == 0x000028, "Wrong size on FMovieSceneBindingOverrideData");
...
// 0x0018 (0x0018 - 0x0000)
struct alignas(0x08) FMovieSceneSequenceCachedSignature final
{
public:
...
static_assert(alignof(FMovieSceneSequenceCachedSignature) == 0x000008, "Wrong alignment on FMovieSceneSequenceCachedSignature");
...
public:
	...
	class FName                                   m_VfxActiveCutId;                                  // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EndCutSceneOptionFlag;                             // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  Guid;                                              // 0x001C(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Name;                                              // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UClass*                                 PossessedObjectClass;                              // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                  ParentGuid;                                        // 0x0048(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
static_assert(offsetof(FMovieScenePossessable, m_VfxActiveCutId) == 0x000010, "Member 'FMovieScenePossessable::m_VfxActiveCutId' has a wrong offset!");
static_assert(offsetof(FMovieScenePossessable, EndCutSceneOptionFlag) == 0x000018, "Member 'FMovieScenePossessable::EndCutSceneOptionFlag' has a wrong offset!");
static_assert(offsetof(FMovieScenePossessable, Guid) == 0x00001C, "Member 'FMovieScenePossessable::Guid' has a wrong offset!");
static_assert(offsetof(FMovieScenePossessable, Name) == 0x000030, "Member 'FMovieScenePossessable::Name' has a wrong offset!");
static_assert(offsetof(FMovieScenePossessable, PossessedObjectClass) == 0x000040, "Member 'FMovieScenePossessable::PossessedObjectClass' has a wrong offset!");
static_assert(offsetof(FMovieScenePossessable, ParentGuid) == 0x000048, "Member 'FMovieScenePossessable::ParentGuid' has a wrong offset!");
...
// 0x0058 (0x0058 - 0x0000)
struct alignas(0x08) FMovieSceneTrackCompilationParams final
{
public:
	...
	uint8                                         Pad_2[0x56];                                       // 0x0002(0x0056)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneTrackCompilationParams) == 0x000008, "Wrong alignment on FMovieSceneTrackCompilationParams");
static_assert(sizeof(FMovieSceneTrackCompilationParams) == 0x000058, "Wrong size on FMovieSceneTrackCompilationParams");
