...
// Class MovieScene.VfxSequencerSettings
// 0x0008 (0x0030 - 0x0028)
class UVfxSequencerSettings final : public UObject
{
public:
	bool                                          m_bEnableCutRangeToLightTrackSectionRange;         // 0x0028(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          m_bStopSequencerPlayInGame;                        // 0x0029(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VfxSequencerSettings">();
	}
	static class UVfxSequencerSettings* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVfxSequencerSettings>();
	}
};
static_assert(alignof(UVfxSequencerSettings) == 0x000008, "Wrong alignment on UVfxSequencerSettings");
static_assert(sizeof(UVfxSequencerSettings) == 0x000030, "Wrong size on UVfxSequencerSettings");
static_assert(offsetof(UVfxSequencerSettings, m_bEnableCutRangeToLightTrackSectionRange) == 0x000028, "Member 'UVfxSequencerSettings::m_bEnableCutRangeToLightTrackSectionRange' has a wrong offset!");
static_assert(offsetof(UVfxSequencerSettings, m_bStopSequencerPlayInGame) == 0x000029, "Member 'UVfxSequencerSettings::m_bStopSequencerPlayInGame' has a wrong offset!");
...
public:
	...
	struct FOptionalMovieSceneBlendType           BlendType;                                         // 0x00D0(0x0002)(NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSection) == 0x0000D8, "Wrong size on UMovieSceneSection");
...
static_assert(offsetof(UMovieSceneSection, BlendType) == 0x0000D0, "Member 'UMovieSceneSection::BlendType' has a wrong offset!");
...
public:
	...
	struct FMovieSceneTrackCompilationParams      TemplateParameters;                                // 0x02D0(0x0058)(NativeAccessSpecifierPublic)
	TMap<class UObject*, struct FCachedMovieSceneEvaluationTemplate> InstancedSubSequenceEvaluationTemplates;           // 0x0328(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bParentContextsAreSignificant;                     // 0x0378(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSequence) == 0x000380, "Wrong size on UMovieSceneSequence");
...
static_assert(offsetof(UMovieSceneSequence, InstancedSubSequenceEvaluationTemplates) == 0x000328, "Member 'UMovieSceneSequence::InstancedSubSequenceEvaluationTemplates' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequence, bParentContextsAreSignificant) == 0x000378, "Member 'UMovieSceneSequence::bParentContextsAreSignificant' has a wrong offset!");
...
public:
	...
	EMovieScenePlayerStatus                       Status;                                            // 0x03D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3D9[0x3];                                      // 0x03D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bReversePlayback : 1;                              // 0x03DC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bPendingFirstUpdate : 1;                           // 0x03DC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_3DD[0xB];                                      // 0x03DD(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieSceneSequence*                    Sequence;                                          // 0x03E8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TimeCursorPosition;                                // 0x03F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         StartTime;                                         // 0x03F4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         EndTime;                                           // 0x03F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         CurrentNumLoops;                                   // 0x03FC(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_400[0x10];                                     // 0x0400(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x0410(0x0028)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_438[0x3E8];                                    // 0x0438(0x03E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieSceneSequencePlayer, Status) == 0x0003D8, "Member 'UMovieSceneSequencePlayer::Status' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Sequence) == 0x0003E8, "Member 'UMovieSceneSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TimeCursorPosition) == 0x0003F0, "Member 'UMovieSceneSequencePlayer::TimeCursorPosition' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, StartTime) == 0x0003F4, "Member 'UMovieSceneSequencePlayer::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, EndTime) == 0x0003F8, "Member 'UMovieSceneSequencePlayer::EndTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x0003FC, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x000410, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
