...
{
public:
	uint8                                         Pad_28[0xAD8];                                     // 0x0028(0x0AD8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000B00, "Wrong size on UAssetRegistryImpl");
