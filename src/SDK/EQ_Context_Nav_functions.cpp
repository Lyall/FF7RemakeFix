...
#include "EQ_Context_Nav_classes.hpp"
#include "EQ_Context_Nav_parameters.hpp"
...
void UEQ_Context_Nav_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQ_Context_Nav_C", "ProvideSingleLocation");

	Params::EQ_Context_Nav_C_ProvideSingleLocation Parms{};
