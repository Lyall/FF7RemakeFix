...
public:
	...
	struct FMovieSceneCaptureSettings             Settings;                                          // 0x0048(0x0070)(Edit, Config, NativeAccessSpecifierPublic)
	bool                                          bUseSeparateProcess;                               // 0x00B8(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCloseEditorWhenCaptureStarts;                     // 0x00B9(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BA[0x6];                                       // 0x00BA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AdditionalCommandLineArguments;                    // 0x00C0(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InheritedCommandLineArguments;                     // 0x00D0(0x0010)(Edit, ZeroConstructor, Transient, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E0[0x158];                                     // 0x00E0(0x0158)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieSceneCapture, bUseSeparateProcess) == 0x0000B8, "Member 'UMovieSceneCapture::bUseSeparateProcess' has a wrong offset!");
static_assert(offsetof(UMovieSceneCapture, bCloseEditorWhenCaptureStarts) == 0x0000B9, "Member 'UMovieSceneCapture::bCloseEditorWhenCaptureStarts' has a wrong offset!");
static_assert(offsetof(UMovieSceneCapture, AdditionalCommandLineArguments) == 0x0000C0, "Member 'UMovieSceneCapture::AdditionalCommandLineArguments' has a wrong offset!");
static_assert(offsetof(UMovieSceneCapture, InheritedCommandLineArguments) == 0x0000D0, "Member 'UMovieSceneCapture::InheritedCommandLineArguments' has a wrong offset!");
...
public:
	...
	bool                                          bDumpHDRToPQ;                                      // 0x0039(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCompositionGraphCaptureSettings, bDumpHDRToPQ) == 0x000039, "Member 'UCompositionGraphCaptureSettings::bDumpHDRToPQ' has a wrong offset!");
...
public:
	...
	struct FGuid                                  PrerequisiteActorId;                               // 0x0248(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(ULevelCapture, PrerequisiteActorId) == 0x000248, "Member 'ULevelCapture::PrerequisiteActorId' has a wrong offset!");
