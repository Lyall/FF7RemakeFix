...
bool UBattleTalk_Base_C::OnNotifyWithAbility(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara, class AEndCharacter* targetChara, class FName& AbilityID, struct FEndDataTableBattleAbility& dataTableBattleAbility, bool bFinishBlow) const
{
...
bool UBattleTalk_Base_C::OnNotify(class FName& AnimName, class FName& SoundName, class AEndCharacter* ownerChara) const
{
	static class UFunction* Func = nullptr;
